          ...
          title:Text("Your Filters"),
            ...
            body:  Column(
              children: [
                ...
                subtitle: Text("Only Include Gluten Free item",style: Theme.of(context).textTheme.labelMedium!.copyWith(
                    color: Theme.of(context).colorScheme.onSurface,
                ),
                ),
                ...
                subtitle: Text("Only Include Lactose Free item",style: Theme.of(context).textTheme.labelMedium!.copyWith(
                    color: Theme.of(context).colorScheme.onSurface,
                ),
                ),
                activeColor: Theme.of(context).colorScheme.tertiary,
                ...
                subtitle: Text("Only Include Vegetarian  item",style: Theme.of(context).textTheme.labelMedium!.copyWith(
                    color: Theme.of(context).colorScheme.onSurface,
                ),
                ),
                activeColor: Theme.of(context).colorScheme.tertiary,
                ...
                subtitle: Text("Only Include Vegan item",style: Theme.of(context).textTheme.labelMedium!.copyWith(
                    color: Theme.of(context).colorScheme.onSurface,
                ),
                ),
                activeColor: Theme.of(context).colorScheme.tertiary,
